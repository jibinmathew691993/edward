...
2. Idiomatic TensorFlow Estimator
  + Call train(). It is a higher-order function taking in the model
    program, data, an optional inference function to build the
...
def _gan_update(train_op, train_op_d, n_print, summarize=None, train_writer=None,
            variables=None, *args, **kwargs):
  """Run one iteration of optimization.
